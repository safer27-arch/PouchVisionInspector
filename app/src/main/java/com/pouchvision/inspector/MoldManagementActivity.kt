...
class MoldManagementActivity : AppCompatActivity() {
    ...
    private val exportLauncher =
        registerForActivityResult(
            ...
            try {
                ...
                val current =
                    ProductionContextStore.getCurrent(this)

                val csv =
                    MoldMaintenanceStore.csvText(
                        this,
                        current.model,
                        current.line
                    )
            ...
            LinearLayout(this).apply {
                ...
                addView(
                    TextView(
                        ...
                        text =
                            "Mold · Punch Shot / Cleaning / Replacement"
        ...
        content.addView(
            actionButton(
                ...
                startActivity(
                    Intent(
                        this,
                        TrainingReviewActivity::class.java
                    )
                )
            }
        )
    ...
    private fun loadState() {
        ...
        val state =
            MoldMaintenanceStore.loadState(
                this,
                current.model,
                current.line
            )
        ...
        editCleanLimit.setText(
            state.cleaningLimit
                .toString()
        )

        editReplaceLimit.setText(
            ...
            if (
                ...
                recent.joinToString(
                    ...
                    buildString {
                        ...
                        append(
                            "Mold ${it.moldId} | Punch ${it.punchId}"
                        )
